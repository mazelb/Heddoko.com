<section class="slider-home">
    <div class="container">
        <div class="col-xs-12 col-md-12 col-mg-8 content fitbox">
            ...
            <h1>Wearable motion capture technology <span>Fully integrated sensors that capture your every move in 3D.</span></h1>
                    ...
                    <form class="form" action="http://heddoko.us8.list-manage.com/subscribe/post-json?u=4752cc710a498b9b75d697500&amp;id=b22a426cab&amp;c=?" method="get" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" novalidate="">
                        <div id="mc_embed_signup_scroll">
                            <div class="mc-field-group form-group">
                                <input type="email" class="form-control" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Email Address">
                            </div>
                            <div class="mc-field-group form-group">
                                <input type="text" class="form-control" value="" name="FNAME" class="" id="mce-FNAME" placeholder="First Name">
                            </div>
                            <div class="mc-field-group form-group">
