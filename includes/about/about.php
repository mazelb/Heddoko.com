		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" data-animated="0">
				<span class="icon bulb">
					<img src="../images/icons/icon_bulb_green.svg">
					<img src="../images/icons/icon_bulb.svg" class="green">
				</span>
				<h4>Cutting-edge</h4>
			...
			<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" data-animated="0">
				<span class="icon heart">
					<img src="../images/icons/icon_heart.svg" class="green">
					<img src="../images/icons/icon_heart_green.svg">
				</span>
				<h4>Passionate</h4>
